...
export const PreviewComponent: React.FunctionComponent<PreviewComponentProps> = ({
	...
	const { key, connectors, width, height, paths } = selected;
				...
				<CustomizeElementsStyled>
					...
					<PreviewContenButtonsStyled>
						...
						<Popover
							...
							<Popover.Content>
								<PopoverWrapStyled>
									<Button fullWidth variant="outlined" onClick={() => onCopyToClipboard(paths)}>
										<Icon data={copy}></Icon>Copy paths string
									</Button>
