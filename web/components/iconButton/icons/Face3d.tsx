...
export const Face3d = (): ReactElement => (
	<svg strokeWidth="1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		<path
		...
		<path
			...
			strokeLinecap="round"
			strokeLinejoin="round"></path>
		<path d="M12 21L12 12" stroke="#000000" strokeWidth="1" strokeLinecap="round" strokeLinejoin="round"></path>
		<path
