...
export const FloppyDisk = (props: SVGAttributes<SVGElement>): ReactElement => (
	<svg {...props} strokeWidth="1" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
		...
		<path
			...
			strokeWidth="1"></path>
		<path d="M6 13.6V21H18V13.6C18 13.2686 17.7314 13 17.4 13H6.6C6.26863 13 6 13.2686 6 13.6Z" strokeWidth="1"></path>
	</svg>
);
