...
export const Wrench = (props: SVGAttributes<SVGElement>): ReactElement => (
	<svg {...props} viewBox="0 0 24 24" strokeWidth="1" fill="none" xmlns="http://www.w3.org/2000/svg">
		<g clipPath="url(#clip0_2576_14436)">
			<path
