...
type SelectableObject = Extract<
  WorldObjectType,
  "Connector" | "CenterOfRotation" | "Label"
>;
...
export type SelectedObject =
  | Selection<"Connector", SymbolConnector>
  | Selection<"CenterOfRotation", Point>
...
export type SymbolEditorEvent =
  | SymbolEvent
  | ConnectorEvent
  | SelectionEvent
  | CenterOfRotationEvent;
