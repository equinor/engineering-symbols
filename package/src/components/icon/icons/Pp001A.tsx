...
const SvgPp001A = (props: SVGProps<SVGSVGElement>) => (
	<svg viewBox="0 0 96 96" xmlns="http://www.w3.org/2000/svg" {...props}>
		<g id="PP001A">
			<g id="Symbol">
				<path d="M52 40.5C52 38.2909 50.2091 36.5 48 36.5C45.7909 36.5 44 38.2909 44 40.5C44 42.7091 45.7909 44.5 48 44.5C50.2091 44.5 52 42.7091 52 40.5ZM51 40.5C51 42.1569 49.6569 43.5 48 43.5C46.3431 43.5 45 42.1569 45 40.5C45 38.8431 46.3431 37.5 48 37.5C49.6569 37.5 51 38.8431 51 40.5Z" />
